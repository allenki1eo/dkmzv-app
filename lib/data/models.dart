...
class GivingPurpose {
  ...
  factory GivingPurpose.fromJson(Map<String, dynamic> j) =>
      GivingPurpose(id: _s(j['id']), sw: _s(j['sw']), en: _s(j['en']));
...
class GivingConfig {
  ...
  factory GivingConfig.fromJson(Map<String, dynamic> j) => GivingConfig(
    ...
    purposes: (j['purposes'] as List? ?? [])
        .map((e) => GivingPurpose.fromJson(Map<String, dynamic>.from(e as Map)))
        .toList(),
    categories: (j['categories'] as List? ?? [])
        .map(
          (e) => GivingCategory.fromJson(Map<String, dynamic>.from(e as Map)),
        )
        .toList(),
